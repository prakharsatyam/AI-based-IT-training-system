  ...
  return (
    <motion.nav variants={navmotion} whileInView="show" initial="hidden" className={`py-5 relative`}>
      ...
      <div className={`flex mx-auto align-center items-center justify-between gap-8`}>
        ...
        <h2 className='font-extrabold text-[24px] leading-[30px] text-black'>BREEZE</h2>
        <button className={'bg-green-400 font-bold hover:bg-green-700 hover:text-white py-2 px-4 rounded-lg items-center'}>
          Get started
        </button>
      </div>
